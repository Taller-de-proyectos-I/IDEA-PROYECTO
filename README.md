# Implementación de un sistema de visión por computadora con CNN para diagnosticar enfermedades en hojas de cultivos andinos, logrando al menos 85 % de precisión en comunidades agrícolas de Cusco
